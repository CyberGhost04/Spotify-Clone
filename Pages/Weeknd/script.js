...
async function getSongs() {
    let a = await fetch("http://127.0.0.1:5501/songs/Weeknd"); // change this for each folder
    ...
    for (let index = 0; index < as.length; index++) {
        ...
        if (element.href.endsWith(".mp3")) {
            songs.push(element.href.split("/songs/Weeknd/")[1]); //change this for each folder
        }
    }
    return songs;
}
...
const playMusic = (track) => {
    ...
    currentSong.src = "/songs/Weeknd/" + track;
    currentSong.play();
